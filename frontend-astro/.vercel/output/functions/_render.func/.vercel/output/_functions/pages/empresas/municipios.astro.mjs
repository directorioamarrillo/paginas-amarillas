...
function ListadoMunicipio({ municipios }) {
  ...
  const onDelete = async (id) => {
    setOnDeleting(id);
    await axiosInstance(`/municipios/${id}`, {
      method: "DELETE"
    });
    ...
    /* @__PURE__ */ jsxs("form", { className: "content-form", onSubmit, ref: form, children: [
      /* @__PURE__ */ jsxs("div", { className: "content-input", children: [
        /* @__PURE__ */ jsxs("label", { htmlFor: "nombre", style: { display: "flex", alignItems: "center", gap: "0.3rem" }, children: [
          /* @__PURE__ */ jsx(MdLocationOn, { style: { fontSize: "1.1rem", color: "#2563eb" } }),
          " Nombre"
        ] }),
        /* @__PURE__ */ jsx(
          "input",
      ...
      /* @__PURE__ */ jsxs("table", { children: [
        ...
        /* @__PURE__ */ jsx("tbody", { children: !!list.length ? list.map((categoria) => /* @__PURE__ */ jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsxs("div", { className: "content-action-table", children: [
            ...
            /* @__PURE__ */ jsx("button", { onClick: () => onDelete(categoria.id_municipio), children: onDeleting === categoria.id_municipio ? /* @__PURE__ */ jsx(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
                width: "24",
        ...
        ] }, categoria.id_municipio)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 2, children: "Sin registros" }) }) })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "GlobalLayout", $$GlobalLayout, { "title": "Municipios", "data-astro-cid-k3r7bpmk": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="content-form-crear-empresa" data-astro-cid-k3r7bpmk> <section data-astro-cid-k3r7bpmk> <h2 data-astro-cid-k3r7bpmk>Municipios</h2> ${renderComponent($$result2, "ListadoMunicipio", ListadoMunicipio, { "municipios": dataMunicipio || [], "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/components/ListadoMunicipios", "client:component-export": "ListadoMunicipio", "data-astro-cid-k3r7bpmk": true })} </section> </div> ` })}`;
}, "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/pages/empresas/municipios/index.astro", void 0);

const $$file = "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/pages/empresas/municipios/index.astro";
const $$url = "/empresas/municipios";
