...
function CrearCuenta() {
  ...
  return /* @__PURE__ */ jsxs("form", { className: "content-form", onSubmit, children: [
    ...
    statusForm.success && /* @__PURE__ */ jsx("span", { className: "success-form", children: "¡Cuenta creada exitosamente! Redirigiendo..." }),
    /* @__PURE__ */ jsx("div", { className: "content-submit", children: /* @__PURE__ */ jsx("button", { type: "submit", disabled: statusForm.isLoading, children: statusForm.isLoading ? "Creando cuenta..." : "Crear cuenta" }) }),
    /* @__PURE__ */ jsxs("div", { className: "content-login-link", children: [
      /* @__PURE__ */ jsx("span", { children: "¿Ya tienes una cuenta?" }),
      /* @__PURE__ */ jsx("a", { href: "/iniciar-sesion", children: "Iniciar sesión" })
    ] })
  ] });
}

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "GlobalLayout", $$GlobalLayout, { "title": "Crear cuenta", "auth": true, "data-astro-cid-gbebtaey": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="content-form-inicio-sesion" data-astro-cid-gbebtaey> <section data-astro-cid-gbebtaey> <h2 data-astro-cid-gbebtaey>Crear cuenta</h2> ${renderComponent($$result2, "CrearCuenta", CrearCuenta, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/components/Formularios/CrearCuenta", "client:component-export": "CrearCuenta", "data-astro-cid-gbebtaey": true })} <div class="content-crear-cuenta" data-astro-cid-gbebtaey> <span data-astro-cid-gbebtaey>¿Ya tienes una cuenta?</span> <a href="/iniciar-sesion" data-astro-cid-gbebtaey>Inicia sesión aquí</a> </div> </section> </div> ` })}`;
}, "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/pages/crear-cuenta/index.astro", void 0);

const $$file = "C:/Users/santi/Documents/DIRECTORIO2.0/Frontend/src/pages/crear-cuenta/index.astro";
